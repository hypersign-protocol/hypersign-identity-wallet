export const HS_NODE_BASE_URL = process.env.VUE_APP_HS_NODE_BASE_URL || "https://api.fyre.hypersign.id/core/";
export const SUPERHERO_HS_AUTH_BASE_URL = process.env.VUE_APP_HS_AUTH_BASE_URL || "https://api.fyre.hypersign.id/hsauth/";
