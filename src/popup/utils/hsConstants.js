export const SUPERHERO_HS_AUTH_BASE_URL =
  process.env.VUE_APP_HS_AUTH_BASE_URL || "https://authserver.hypersign.id/";
// export const SUPERHERO_HS_AUTH_BASE_URL =
...
export const WALLET_URL = process.env.VUE_APP_WALLET_URL || "https://wallet-prajna.hypersign.id/";
// export const WALLET_URL =
// process.env.VUE_APP_WALLET_URL || 'http://localhost/';
